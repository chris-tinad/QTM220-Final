...
Our research questions generally focus on the exploration of the predictors for danceability since we wanted to understand why Spotify would include this as a metric for their algorithm.

**Phase 1: Is danceability an "interaction variable" for Spotify's algorithm? Possible predictors for danceability?**
...
**Phase 2: Why might Spotify include danceability as a predictor in general?**

Possible Answers **(Hypothesis)**:

-   Curated playlists (for a dance class, study playlist, etc.)

-   

1.  **Categorical Predictors**: Genre specific danceability produce more danceable music than others?
    1.  Sub-Question: Is there a difference in danceability between explicit tracks and clean tracks?
2.  **Genre-Specific Analysis**: Do "dance" genre songs have different danceability predictors than other genres?
